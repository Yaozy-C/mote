...
- Permission readiness must refresh automatically when the native Mote window regains focus after System Settings, and while the Settings popover remains open; users should not need to click “Check again” after granting access.
